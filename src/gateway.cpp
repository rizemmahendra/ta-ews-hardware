...
#define WIFI_SSID "Base Tekom 19"
#define WIFI_PASSWORD "hamdanganteng123"
...
void setup()
{
    ...
    {
        connection->initializeFirebase(API_KEY, DATABASE_URL, USER_EMAIL, USER_PASSWORD);
    }
    // FirebaseJson node1;
    // FirebaseJson node2;
    // node1.set("water_level", 1);
    // node1.set("water_level_status", 2);
    // node1.set("turbidity", 3);
    // node1.set("turbidity_status", 4);
    // node1.set("rain_intensity", 5);
    // node1.set("rain_intensity_status", 6);
    // node1.set("level_danger", 7);
    // node2.set("water_level", 1);
    // node2.set("water_level_status", 2);
    // node2.set("turbidity", 3);
    // node2.set("turbidity_status", 4);
    // node2.set("rain_intensity", 5);
    // node2.set("rain_intensity_status", 6);
    // node2.set("level_danger", 7);
    // FirebaseJson allData;
    // allData.set("node1", node1);
    // allData.set("node2", node2);
    // Serial.println(allData.raw());
}
...
void loop()
{
    if (connection->ready())
    {
        connection->updateDataFirebase(&allData);
    }
}